...
def poi_infobox(frame, x, y, subject_number, subject_name, subject_type):
    ...
    cv2.putText(infobox, id_type, (15, 45),
                cv2.FONT_HERSHEY_SIMPLEX, 1, id_colour, 2)
    cv2.putText(infobox, id_alias, (15, 92),
                cv2.FONT_HERSHEY_SIMPLEX, 1, (12, 12, 12), 2)
    cv2.putText(infobox, "SSN:", (15, 150),
                cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 255), 2)
    cv2.putText(infobox, id_num, (125, 150),
                cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 255), 2)
...
def poi_statusbox_old(frame, x, y, uptime, subjectno):
    ...
    cv2.putText(statusbox, "STATUS:", (15, 45),
                cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 255), 2)
    cv2.putText(statusbox, "ACTIVE", (150, 45),
                cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2)
    cv2.putText(statusbox, "UPTIME: {}".format(uptime), (15, 92),
                cv2.FONT_HERSHEY_SIMPLEX, 1, (12, 12, 12), 2)
    cv2.putText(statusbox, "SUBJECTS DETECTED: {}".format(subjectno),
                (15, 135), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 255), 2)
...
def poi_statusbox(frame, x, y, uptime, subjectno):
    ...
    cv2.putText(statusbox, "o", (30, 33),
                cv2.FONT_HERSHEY_SIMPLEX, .25, (000, 255, 000), 15)
    cv2.putText(statusbox, "PROGRAM: THE MACHINE", (55, 45),
                cv2.FONT_HERSHEY_SIMPLEX, 1.2, (220, 220, 220), 2)
    cv2.putText(statusbox, "STATUS:", (10, 85),
                cv2.FONT_HERSHEY_SIMPLEX, 1, (13, 13, 13), 2)
    cv2.putText(statusbox, "ACTIVE", (150, 85),
                cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2)
    cv2.putText(statusbox, "UPTIME: {}".format(uptime), (15, 130),
                cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 255), 2)
    cv2.putText(statusbox, "SUBJECTS DETECTED: {}".format(subjectno),
                (15, 168), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 255), 2)
